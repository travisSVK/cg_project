...
void FlareManager::render(const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix, const glm::vec3& lightPosition, GLuint depthBuffer)
{
    ...
    glm::vec2 lightCoords = convertToScreenSpace(lightPosition, newViewMatrix, projectionMatrix);
...
void FlareManager::loadTextures()
{
    ...
    engine::Texture tex6 = loadTexture("../scenes/tex6.png", "sun");
...
engine::Texture FlareManager::loadTexture(const char* path, const std::string& name)
{
    int w, h, comp;
